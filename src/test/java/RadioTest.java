...
public class RadioTest {
    ...
    @Test
    public void OneTestMaxStationmetodNext() {             //Задание 3 - радиостанции (использование maxstation)
    ...
    @Test
    public void TwoTestMaxStationmetodNext() {             //Задание 3 - радиостанции (использование maxstation)
        Radio radio = new Radio(54);
    ...
    @Test                                                 //Задание 4 - радиостанции (предыдущая радиостанция)
